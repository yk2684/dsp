...
>> Frequentist statistics is an orthodox view that sampling is infinite and decision rules can be sharp. However Bayesian statistics would say that unknown quantities are treated probabilistically and the state of the world can always be updated.
